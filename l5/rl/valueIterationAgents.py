...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for i in range(self.iterations): 
            ...
            for state in self.mdp.getStates():
                ...
                #updating the utility of that state
                if(bestAction != None):
                    self.tempValues[state]=self.computeQValueFromValues(state, bestAction)
    ...
    def computeQValueFromValues(self, state, action):
        ...
        "*** YOUR CODE HERE ***"
        QValue = 0
        #computing Q value of a state action pair
    ...
    def computeActionFromValues(self, state):
        ...
        #checking if there is any legal actions
        ...
        for action in self.mdp.getPossibleActions(state):
            #finding action with maximum QValue
